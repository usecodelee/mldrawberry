/**
 * 根据我当前的圣诞帽元素进行一些偏移(我的图片大小是200*120)， 圣诞帽可佩戴部分的中心 (62,60)  这里需要微调
 * 图片可佩戴部分是 0.6 倍图片宽度
 * @param {*} x
 * @param {*} y
 */
 ...
 * @param {{}} config 配置
 */
function drawHat(ctx, config, hatUrl) {
 ...
 * @param {*} options
 */
function drawing(canvas, options, hatUrl) {
  const { info, width = 200, height = 200, imgSrc } = options;
